// <copyright file="ExponentNode.cs" company="Martin Hundrup">
...
namespace Spreadsheet_Engine.Expression
{
    ...
    {
        /// <summary>
        /// Initializes static members of the <see cref="ExponentNode"/> class.
        /// </summary>
        static ExponentNode()
        {
            Operation = '^';
        ...
        /// </summary>
        /// <returns>The results of the left subtree multiplied by the results of the right.</returns>
        public override double Evaluate()
        {
            if (this.nLeft != null && this.nRight != null)
            {
                return Math.Pow(this.nLeft.Evaluate(), this.nRight.Evaluate());
            }
            else
            {
